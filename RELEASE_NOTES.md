...
- OpenAI explanation source contracts are stricter: prompt inputs are allowlisted, provider errors strip URLs and secret-shaped values, and unsafe generated wording falls back before it can show trade commands, price targets, return predictions, guaranteed language, or unsupported causal news claims.
