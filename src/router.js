export const APP_ROUTES = Object.freeze({
  ...
  "risk-guardrails": { title: "Equity Risk Guardrails", description: "Hold, review, trim, or exit-review triggers for individual holdings." },
  ...
  "research-coverage": { title: "Research Coverage", description: "See which holdings have current imported research context and which need review." },
...
export const ROUTE_ALIASES = Object.freeze({
  ...
  "equity-risk": "risk-guardrails",
  "risk-guardrail": "risk-guardrails",
  simulate: "what-if",
  simulator: "what-if",
  whatif: "what-if",
  rebalance: "targets",
  research: "research-coverage",
  "research-queue": "research-coverage",
  coverage: "research-coverage",
  "sa-ai": "research-coverage",
  ideas: "watchlist",
  idea: "watchlist",
  pipeline: "watchlist",
